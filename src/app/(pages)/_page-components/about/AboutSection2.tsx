...
export default function AboutSection2() {
  ...
  return (
    <div className="bg-[#FFF4F1] text-justify px-8 md:px-16 py-10 md:py-20 ">
      ...
      <div className="grid md:grid-cols-2  ">
        <div className="  md:order-last">
          ...
          {/* our mission in our vision section  */}
      ...
      <div className="lg:grid lg:grid-cols-2 lg:mt-10">
        ...
        {/* image  */}
        <div className="md:flex md:gap-5 lg:gap-0 md:justify-center md:mt-5 ">
          <div className="max-md:mr-28 max-md:mt-5 flex max-md:justify-center  lg:mr-[-20px]">
            <Image
              ...
              width={150}
              height={50}
              className="shadow-2xl md:w-60 lg:w-52 lg:h-72"
            />
          </div>
          <div className="max-md:ml-28 max-md:mt-[-90px] flex max-md:justify-center lg:ml-[-20px]">
            <Image
              ...
              width={150}
              height={50}
              className="shadow-2xl md:w-60 lg:w-52 lg:h-72 lg:flex lg:mt-40 "
            />
          </div>
        </div>
      </div>
