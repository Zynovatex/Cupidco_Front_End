    ...
    <div className="flex items-center justify-center h-screen p-6">
      ...
      >
        ...
        <div className=" flex justify-center">
          <p className="text-[#4D194D] text-sm mt-4">
            You can upload Maximum 5 Videos
          </p>
        </div>
        ...
        <div className="flex justify-center space-x-4 p-6 sm:p-4 md:p-6 lg:p-8 xl:p-10">
          ...
          />
          {/* Hidden file input to trigger the file browser */}
...
export default ProfileVideosUpload;
