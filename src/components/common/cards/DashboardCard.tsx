...
import DashboardSliderImages from '../sliders/DashboardSliderImages';
            ...
            {profiles.map((profile, index) => (
                <div key={index} className="relative w-[300px]">
                    ...
                    <div className="swiper-container">
                        ...
                        <SwiperNavButtons slidePrev={() => slidePrev(index)} slideNext={() => slideNext(index)} />
                    </div>
                    ...
                    <div className="bottom-div relative bottom-0 w-full h-auto bg-white rounded-b-2xl p-2 flex flex-col shadow-lg">
                        ...
                        <div className="interaction-icons absolute flex gap-1 justify-end items-center transform -translate-y-5 z-10 cursor-pointer right-2">
                            <img src="/images/Reject.png" alt="Reject" className="w-8 h-8" title="Reject" />
                            <img src="/images/Like.png" alt="Like" className="w-8 h-8" title="Like" />
                            <img src="/images/bookmark.png" alt="Heart" className="w-8 h-8" title="Heart" />
                            <img src="/images/ProfileIcon1.png" alt="BookMark" className="w-8 h-8" title="BookMark" />
                            <img src="/images/ProfileIcon3.png" alt="Super Like" className="w-8 h-8" title="Super Like" />
                            <img src="/images/Chat.png" alt="Chat" className="w-8 h-8" title="Chat" />
                        </div>
                        ...
                        <div className="flex name mt-5 gap-1">
                            ...
                            <Description text={`(${profile.profession})`}
                                fontFamily="font-playfair-display"
                        ...
                        <div className="Address flex justify-between items-center">
                            <div className="text-primary-purple cursor-pointer" onClick={() => handleDescriptionClick(profile.name, profile.address)}>
                                <div className='flex flex-row items-center gap-2'>
                                    <Description
                                        ...
                                        fontSize="text-md md:text-md lg:text-lg xl:text-xl"
                                    />
                                    <img src="/images/locationIcon.png" alt="Location Icon" className="w-5 h-5" />
                                </div>
                            </div>
                                        ...
                                        <div className="flex flex-col gap-5 items-start mt-5 w-full">
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                ...
                                                {profile.interests.length > 5 && (
                                                    <Chip text={`+${profile.interests.length - 5}`} fontColor='text-primary-purple' width='w-auto' />
                                                )}
                                            </div>
                                        </div>
                                    )}
